  ...
  TThread.CreateAnonymousThread(
    ...
    begin
      ...
      begin
        ...
        RttiType :=TRttiContext.Create.GetType(FReceiver.ClassType);
...
begin
 ...
 try
  if ScriptGateFactory<>nil then
  begin
    FGate := ScriptGateFactory.CreateScriptGate(Self);
